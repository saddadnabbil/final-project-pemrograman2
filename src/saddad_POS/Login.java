...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setMinimumSize(new java.awt.Dimension(1089, 649));
        jPanel2.setPreferredSize(new java.awt.Dimension(1089, 649));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/logo-unpam-300x291 1.png"))); // NOI18N
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 120, 190, 130));

        jLabel7.setFont(new java.awt.Font("Segoe UI Emoji", 0, 20)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel7.setText("POS UNPAM APP");
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 260, 310, -1));
        ...
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 10, -1, -1));
    ...
    private void jLabel16MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel16MouseClicked
        ...
        try{
           ...
           if(Username.getText().equals("Enter username") & Password.getText().equals("Enter password") & jComboBox1.getSelectedItem().equals("Default")){
                ...
                JOptionPane.showMessageDialog(rootPane, "Data successfully created!");
